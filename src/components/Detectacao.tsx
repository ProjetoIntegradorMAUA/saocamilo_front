    ...
    return (
        <div>
            <div className="flex items-center gap-2 text-3xl text-black mb-4">
                <span className="border border-gray-300 rounded-3xl">{icons.negativo}</span>
                <p>Detectação de Inconsistências</p>
            </div>
            <div className="border border-gray-300 rounded-3xl p-3 sm:p-6 bg-white w-full min-h-35 sm:min-h-55 flex flex-col gap-3 sm:gap-4 justify-center">
