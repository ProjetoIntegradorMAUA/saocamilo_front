    ...
    return (
        <div>
            <div className="flex items-center gap-2 text-3xl text-black mb-4">
                <span className="border border-gray-300 rounded-3xl">{icons.estrela}</span>
                <p>Escala Visual</p>
            </div>
            <div className="border border-gray-300 rounded-3xl gap-3 py-4 sm:py-8 w-full bg-white px-2 sm:px-8">
                ...
                <div className="w-full max-w-275 mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 items-stretch">
                        <div className="bg-[#A7E7B6] border border-gray-300 rounded-xl px-4 py-3 text-gray-800 font-medium text-center min-h-[56px] flex items-center justify-center text-sm sm:text-base">
                            Níveis 1-3: Bem Hidratado
                        </div>
                        <div className="bg-[#F5EDB5] border border-gray-300 rounded-xl px-4 py-3 text-gray-800 font-medium text-center min-h-[56px] flex items-center justify-center text-sm sm:text-base">
                            Níveis 4-6: Desidratado
                        </div>
                        <div className="bg-[#F6A3A8] border border-gray-300 rounded-xl px-4 py-3 text-gray-800 font-medium text-center min-h-[56px] flex items-center justify-center text-sm sm:text-base">
